...
<!-- Mirrored from doccure-laravel.dreamguystech.com/template/public/pharmacy-admin/login by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 04 Oct 2023 20:54:19 GMT -->
...
<form method="post" action="https://doccure-laravel.dreamguystech.com/template/public/login-custom">
<input type="hidden" name="_token" value="ds36f54zKY4kncS8KNTBktCcXApDIUHXPOjXxQSC"> <div class="mb-3">
<input class="form-control" type="text" placeholder="Email" value="admin@example.com" name="email" id="email">
<div class="text-danger pt-2">
</div>
</div>
<div class="mb-3">
<div class="pass-group">
<input class="form-control pass-input" type="password" placeholder="Password" value="123456" name="password" id="password">
...
<!-- Mirrored from doccure-laravel.dreamguystech.com/template/public/pharmacy-admin/login by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 04 Oct 2023 20:54:22 GMT -->
</html>
