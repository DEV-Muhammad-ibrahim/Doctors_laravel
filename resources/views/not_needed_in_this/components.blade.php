...
<!-- Mirrored from doccure-laravel.dreamguystech.com/template/public/components by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 04 Oct 2023 20:51:42 GMT -->
...
<ol class="breadcrumb">
<li class="breadcrumb-item"><a href="https://doccure-laravel.dreamguystech.com/template/public">Home</a></li>
...
<button class="btn btn-primary custom-components" type="button" data-bs-toggle="modal" data-bs-original-title="test" data-bs-target="#exampleModal">Simple</button>

<button class="btn btn-primary custom-components" type="button" data-bs-toggle="modal" data-bs-target="#exampleModalLong" data-bs-original-title title>Scrolling long content</button>

<button class="btn btn-primary custom-components" type="button" data-bs-toggle="modal" data-bs-target="#exampleModalCenter" data-bs-original-title title>Vertically centered</button>

<button class="btn btn-primary custom-components" type="button" data-bs-toggle="modal" data-bs-target="#tooltipmodal" data-bs-original-title title>Tooltips and popovers</button>

<button class="btn btn-primary custom-components" type="button" data-bs-toggle="modal" data-bs-target="#grid-modal" data-bs-original-title title>Using the grid</button>
</div>
</div>
<div class="card">
<div class="card-header">
...
<button class="btn btn-primary custom-components" type="button" data-bs-toggle="modal" data-bs-target="#exampleModalfat" data-whatever="@mdo" data-bs-original-title title>Open modal for @mdo</button>
<button class="btn btn-primary custom-components" type="button" data-bs-toggle="modal" data-bs-target="#exampleModalmdo" data-whatever="@fat" data-bs-original-title title>Open modal for @fat</button>
<button class="btn btn-primary custom-components" type="button" data-bs-toggle="modal" data-bs-target="#exampleModalgetbootstrap" data-whatever="@getbootstrap" data-bs-original-title title>Open modal for @getbootstrap</button>
</div>
</div>
<div class="card">
<div class="card-header">
...
<button type="button" class="btn btn-primary custom-components" data-bs-toggle="modal" data-bs-target=".bd-example-modal-xl">Extra large modal</button>

<button class="btn btn-primary custom-components" type="button" data-bs-toggle="modal" data-bs-target=".bd-example-modal-lg" data-bs-original-title title>Large modal</button>

<button class="btn btn-primary custom-components" type="button" data-bs-toggle="modal" data-bs-target=".bd-example-modal-sm" data-bs-original-title title>Small modal</button>
</div>
</div>
</section>
...
<p><i class="feather-mail"></i> <a href="https://doccure-laravel.dreamguystech.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="adc9c2ceced8dfc8edc8d5ccc0ddc1c883cec2c0">[email&#160;protected]</a></p>
</div>
</div>
</div>
</div>
...
<p>This <a class="btn btn-primary popover-test" href="javascript:;" role="button" title data-content="Popover body content is set in this attribute." data-container="#exampleModalPopovers" data-bs-original-title="Popover title">button</a>
triggers a popover on click.</p>
<hr>
<h5>Tooltips in a modal</h5>
<p><a class="tooltip-test" href="javascript:;" title data-container="#exampleModalPopovers" data-bs-original-title="Tooltip">This link</a> and <a class="tooltip-test" href="javascript:;" title data-container="#exampleModalPopovers" data-bs-original-title="Tooltip">that link</a> have tooltips on hover.</p>
</div>
<div class="modal-footer">
<button class="btn btn-secondary" type="button" data-bs-dismiss="modal" data-bs-original-title title>Close</button>
<button class="btn btn-primary" type="button" data-bs-original-title title>Save
...
<input class="form-control" type="text" value="@fat" data-bs-original-title title>
</div>
<div class="mb-3">
...
<div class="mb-3">
<label class="col-form-label" for="recipient-name">Recipient:</label>
<input class="form-control" id="recipient-name" type="text" value="@Mat" data-bs-original-title title>
</div>
<div class="mb-3">
<label class="col-form-label" for="message-text">Message:</label>
