                        ...
                        <div class="doctor-widget">
                            <div class="doc-info-left">
                                ...
                                <div class="doc-info-cont">
                                    <h4 class="doc-name">{{$doctors->username}}</h4>
                                    <p class="doc-speciality">{{$doctors->degree}}</p>
                                    <p class="doc-department"><img src="{{asset('assets/img/specialities/specialities-05.png')}}"
                                            class="img-fluid" alt="Speciality">{{$doctors->specialization}}</p>
                                    <div class="rating">
                                    ...
                                    <div class="clinic-details">
                                        <p class="doc-location"><i class="fas fa-map-marker-alt"></i>{{$doctors->state}},
                                            {{$doctors->country}}
                                            </p>
