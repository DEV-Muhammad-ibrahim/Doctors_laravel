                        ...
                        <div class="chat-users-list">
                            <div class="chat-scroll">
                                ...
                                <a href="javascript:void(0);" class="notify-block d-flex open-chat">
                                    <div class="media-img-wrap flex-shrink-0">
                                        <div class="avatar avatar-away">
                                            <img src="{{asset('assets/img/doctors/doctor-thumb-03.jpg')}}" alt="User Image"
                                                class="avatar-img rounded-circle">
                                        </div>
                                    </div>
                                    <div class="media-body chat-custom flex-grow-1">
                                ...
                                <a href="javascript:void(0);" class="notify-block read-chat d-flex open-chat">
                                    <div class="media-img-wrap flex-shrink-0">
                                        <div class="avatar avatar-online">
                                            <img src="{{asset('assets/img/doctors/doctor-thumb-04.jpg')}}" alt="User Image"
                                                class="avatar-img rounded-circle">
                                        </div>
                                    </div>
                                    <div class="media-body chat-custom flex-grow-1">
                                ...
                                <a href="javascript:void(0);" class="notify-block read-chat d-flex open-chat">
                                    <div class="media-img-wrap flex-shrink-0">
                                        <div class="avatar avatar-offline">
                                            <img src="{{asset('assets/img/doctors/doctor-thumb-05.jpg')}}" alt="User Image"
                                                class="avatar-img rounded-circle">
                                        </div>
                                    </div>
                                    <div class="media-body chat-custom flex-grow-1">
                                ...
                                <a href="javascript:void(0);" class="notify-block read-chat d-flex open-chat">
                                    <div class="media-img-wrap flex-shrink-0">
                                        <div class="avatar avatar-online">
                                            <img src="{{asset('assets/img/doctors/doctor-thumb-06.jpg')}}" alt="User Image"
                                                class="avatar-img rounded-circle">
                                        </div>
                                    </div>
                                    <div class="media-body chat-custom flex-grow-1">
                                ...
                                <a href="javascript:void(0);" class="notify-block read-chat d-flex open-chat">
                                    <div class="media-img-wrap flex-shrink-0">
                                        <div class="avatar avatar-away">
                                            <img src="{{asset('assets/img/doctors/doctor-thumb-07.jpg')}}" alt="User Image"
                                                class="avatar-img rounded-circle">
                                        </div>
                                    </div>
                                    <div class="media-body chat-custom flex-grow-1">
                                ...
                                <a href="javascript:void(0);" class="notify-block read-chat d-flex open-chat">
                                    <div class="media-img-wrap flex-shrink-0">
                                        <div class="avatar avatar-offline">
                                            <img src="{{asset('assets/img/doctors/doctor-thumb-08.jpg')}}" alt="User Image"
                                                class="avatar-img rounded-circle">
                                        </div>
                                    </div>
                                    <div class="media-body chat-custom flex-grow-1">
                                ...
                                <a href="javascript:void(0);" class="notify-block read-chat d-flex open-chat">
                                    <div class="media-img-wrap flex-shrink-0">
                                        <div class="avatar avatar-online">
                                            <img src="{{asset('assets/img/doctors/doctor-thumb-09.jpg')}}" alt="User Image"
                                                class="avatar-img rounded-circle">
                                        </div>
                                    </div>
                                    <div class="media-body chat-custom flex-grow-1">
                                ...
                                <a href="javascript:void(0);" class="notify-block read-chat d-flex open-chat">
                                    <div class="media-img-wrap flex-shrink-0">
                                        <div class="avatar avatar-away">
                                            <img src="{{asset('assets/img/doctors/doctor-thumb-10.jpg')}}" alt="User Image"
                                                class="avatar-img rounded-circle">
                                        </div>
                                    </div>
                                    <div class="media-body chat-custom flex-grow-1">
